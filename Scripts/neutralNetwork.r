...
ggplot(data=edata, aes(y=even, x=edata$NTL)) + geom_point(colour="skyblue2",size=2.5) + ylab("Network eveness") + xlab("log10(NTL)") + scale_x_log10()
ggplot(data=edata, aes(y=size, x=edata$NTL)) + geom_point(colour="skyblue2",size=2.5) + ylab("Network size") + xlab("log10(NTL)") + scale_x_log10()
ggplot(data=edata, aes(y=v_out, x=edata$NTL)) + geom_point(colour="skyblue2",size=2.5) + ylab("Variance of weighted out-degree") + xlab("log10(NTL)") + scale_x_log10()
ggplot(data=edata, aes(y=v_in, x=edata$NTL)) + geom_point(colour="skyblue2",size=2.5) + ylab("Variance of weighted in-degree") + xlab("log10(NTL)") + scale_x_log10()
